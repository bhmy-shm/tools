...
import (
	...
	"github.com/bhmy-shm/tools/gofkctl/pkg/parser/api/ast"
	"github.com/bhmy-shm/tools/gofkctl/pkg/parser/api/importstack"
	"github.com/bhmy-shm/tools/gofkctl/pkg/parser/api/placeholder"
	"github.com/bhmy-shm/tools/gofkctl/pkg/parser/api/token"
)
...
func convert2API(a *ast.AST, importSet map[string]struct{}, is *importstack.ImportStack) (*API, error) {
	var api = new(API)
	api.importManager = is
	api.importSet = make(map[string]struct{})
