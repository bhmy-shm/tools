...
import (
	"fmt"
	"github.com/bhmy-shm/tools/gofkctl/pkg/protocgengo"
	"github.com/bhmy-shm/tools/gofkctl/pkg/protocgengogrpc"
	"log"
	"os"
	"path/filepath"
	"runtime"
	...
	sortedmap "github.com/bhmy-shm/tools/gofkctl/pkg/collection"
	"github.com/bhmy-shm/tools/gofkctl/pkg/protoc"
)
...
func init() {
	defaultGoctlHome, err := pathx.GetDefaultCtlHome()
	if err != nil {
		log.Fatalln(err)
	}
