...
func FileNamingFormat(format, content string) (string, error) {
	...
	gofkStyle, err = getStyle(flagGofks)
	if err != nil {
		return "", err
	}
	var formatStyle styleFormat
	formatStyle.goStyle = goStyle
	formatStyle.zeroStyle = gofkStyle
